...
Tags: dewplayer, mp3 player, flash player, advance, advanced,advance dewplayer, directory, mp3, music, songs, page, post
...
`<?php echo do_shortcode("[musicdirectory path="playlist/"]"); //replace playlist with your path ?>`
